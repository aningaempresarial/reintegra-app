...
function Signup() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={isActive? styles.input : styles.input} placeholder='Nome completo' onFocus={() => setActive(true)} onBlur={() => setActive(false)}/>
      </View>
      <View style={styles.inputBox}>
      ...
      <TextInput style={isActive? styles.input : styles.input} placeholder='E-mail' onFocus={() => setActive(true)} onBlur={() => setActive(false)}/>
      </View>
      <View style={styles.inputBox}>
      ...
      <View style={styles.inputBox}>
      <Icon name='key' size={30} color={'rgba(0,0,0,0.5)'}/>
      <TextInput style={isActive? styles.input : styles.input} placeholder='Confirme a senha' onFocus={() => setActive(true)} onBlur={() => setActive(false)}/>
      </View>
